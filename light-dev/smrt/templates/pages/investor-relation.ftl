...
<html xml:lang="${cmsfn.language()}" lang="${cmsfn.language()}">
  <head>
    ...
    [#-- To load resources you can link them manually (e.g. line below) --]
      [#-- <link rel="stylesheet" type="text/css" href="${ctx.contextPath}/.resources/smrt/webresources/css/bootstrap.css" media="all" /> --]
      [#-- <script src="${ctx.contextPath}/.resources/smrt/webresources/js/jquery.js"></script> --]
    [#-- or via theme --]
  ...
  <body class="investor-relation ${cmsfn.language()}">

    <div class="container">
      <h1>investor-relation works!</h1>
    </div>
